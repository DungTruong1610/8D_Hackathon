...
| :------------------------------------- | :------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Member 1 (Backend Lead)**      | Rework AI Adapter & Decouple BTP             | - Viết`standaloneLlmProvider.ts` gọi Gemini API.- Cấu hình DB profile dùng SQLite (`db.sqlite`) mặc định.- Gỡ bỏ các dependency `@cnma/*` nội bộ để repo sạch, `npm install` chạy mượt.                                                                                                        |
